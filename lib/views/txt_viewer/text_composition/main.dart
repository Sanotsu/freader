...
import 'package:freader/views/txt_viewer/text_composition/text_composition.dart';
            ...
            Card(
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    decoration: const InputDecoration(labelText: "字号 size"),
                    controller: size,
                    keyboardType: TextInputType.number,
                  ),
                  TextField(
                    decoration: const InputDecoration(labelText: "行高 height"),
                    controller: height,
                    keyboardType: TextInputType.number,
                  ),
                  TextField(
                    decoration:
                        const InputDecoration(labelText: "段高 paragraph"),
                    controller: paragraph,
                    keyboardType: TextInputType.number,
                  ),
                  SwitchListTile(
                    title: const Text("是否底栏对齐"),
                    subtitle: const Text("shouldJustifyHeight"),
      ...
      children: List.generate(
        ...
        (index) => Container(
          ...
          child: Text(
            ...
            style:
                const TextStyle(color: Colors.white, fontSize: 10, height: 1),
          ),
        ),
      ),
    );

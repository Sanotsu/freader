...
/// 來源： https://stackoverflow.com/questions/49635381/flutter-create-a-timeline-ui
///
...
class Timeline extends StatelessWidget {
  const Timeline({
    ...
    this.itemGap = 12.0, // 时间线相邻条目间隔
    this.gutterSpacing = 4.0, // indicators 和 children 的间隔
    this.padding = const EdgeInsets.all(8), // timeline与四周的间距
    this.controller,
    ...
    this.primary = false,
    this.reverse = false,
    this.indicatorSize = 30.0, // indicators 的尺寸。直接改会变形
    this.lineGap = 4.0,
    this.indicatorColor = Colors.blue,
    this.indicatorStyle = PaintingStyle.fill,
    this.strokeCap = StrokeCap.butt, // 线颜色
    this.strokeWidth = 2.0, // 线宽
  ...
  Widget build(BuildContext context) {
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        final privateIndicators = indicators;

        Widget? indicator;
        if (privateIndicators != null) {
          indicator = privateIndicators[index];
        }
